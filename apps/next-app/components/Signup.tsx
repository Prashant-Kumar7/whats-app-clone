    ...
    return (
        <div className="border-l border-gray-700 col-span-3 flex flex-col justify-center items-center p-6">
                    <div style={{height : "27rem" , width: "28rem"}} className="bg-slate-800 rounded-lg">
                        ...
                        <input className="bg-transparent ml-8 w-96 rounded-lg focus:ring-indigo-900 text-lg text-gray-300 my-8" name="password" placeholder="Enter password" type="password" required/>
                        <input className="bg-transparent ml-8 w-96 rounded-lg focus:ring-indigo-900 text-lg text-gray-300" name="confirmPwd" placeholder="Confirm password" type="password" required/>
                        ...
                        <span onClick={()=>route.push("http://localhost:3000/api/auth/signin?callbackUrl=%2Fchats")} className="ml-8 hover:underline-offset-4 hover:underline hover:text-indigo-300 hover:cursor-pointer text-gray-400">Already have an account?</span>
                    </div>
